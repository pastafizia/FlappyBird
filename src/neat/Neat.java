...
public class Neat {
    ...
    public void init(int input_size, int output_size) {
        double link_prob = this.PROBABILITY_MUTATE_LINK;
        for (int i = 0; i < input_size * output_size; i++) {
            for (Client c : clients.getData()) {
                c.getGenome().mutate_link();
            }
        }
        this.PROBABILITY_MUTATE_LINK = link_prob;
    }
    ...
    private void reproduce() {
        ...
        for (Client c : clients.getData()) {
            if (c.getSpecies() == null) {
                ...
                c.setGenome(s.breed());
                //System.out.println("NEAT 1");
                s.force_put(c);
                //System.out.println("NEAT 2");
            }
        }
    }
    ...
    public void setPROBABILITY_MUTATE_LINK(double pROBABILITY_MUTATE_LINK) {
        PROBABILITY_MUTATE_LINK = pROBABILITY_MUTATE_LINK;
    }
    ...
    public void setPROBABILITY_MUTATE_TOGGLE_LINK(double pROBABILITY_MUTATE_TOGGLE_LINK) {
        PROBABILITY_MUTATE_TOGGLE_LINK = pROBABILITY_MUTATE_TOGGLE_LINK;
    }
